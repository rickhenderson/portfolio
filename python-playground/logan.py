...
__description__ = "Program for analyzing log files. LOg ANalyzer."
__author__ = 'Didier Stevens', 'Rick Henderson'
__version__ = '0.0.9'
__date__ = '2025/05/30'
...
History:
  ...
  2022/05/18: 0.0.6 changed --withfilename to separators
  ...
  2025/05/30: Modified by Rick for LOGAN log analyzer.
...
https://DidierStevens.com'''
    ...
    oParser.add_option('--json', type=str, default='', help='Output with JSON format')
